...
*/
    ...
    while (millis() - current_time < 15000) {
        ...
        if (value == 0) Serial.println("No Beacon Detected!");
        if (value == 1) Serial.println("1khz Beacon detected!");
        if (value == 2) Serial.println("10khz Beacon detected!");
        delay(50);
    }
...
>>>>>>> 5f5d1c348636e48291c3759c10ef8275494c30b3
